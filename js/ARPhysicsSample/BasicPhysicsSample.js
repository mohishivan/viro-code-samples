    ...
    return (
      <ViroNode position={this.state.planePosition}>
        ...
        <Viro3DObject
          ...
          onClick={
            this.state.controllerConfig == CONTROLLER_PUSH
              ? this.onItemPushImpulse('BallTag')
              : undefined
          }
          onDrag={
        ...
        <ViroQuad
          ...
          onClickState={
            this.state.controllerConfig == CONTROLLER_PULL
              ? this.onItemPullForce('Surface')
              : undefined
          }
          ref={(component) => {
            this.floorSurface = component;
          }}
          onCollision={this._onFloorCollide}
          materials={'ground'}
        />
      </ViroNode>
    );
    ...
    return (
      <ViroNode
        ...
        <ViroFlexView
          ...
          materials="hud_text_bg"
          position={[0, 0, 0]}
          onClick={this._toggleControllerInteraction}>
          <ViroText
            style={styles.hud_text}
            text={this._getControllerTextMode()}
          />
        </ViroFlexView>
        ...
        <ViroFlexView
          ...
          materials="hud_text_bg"
          position={[1.5, 0, 0]}
          onClick={this._toggleCollisionBox}>
